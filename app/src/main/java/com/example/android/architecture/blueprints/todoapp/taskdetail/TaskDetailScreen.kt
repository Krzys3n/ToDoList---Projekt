    ...
    LoadingContent(
        ...
        Column(commonModifier.verticalScroll(rememberScrollState())) {
            ...
            Row(
                ...
                if (task != null) {
                    Column {
                        Text(text = "Priority: " + task.priority.toString(), style = MaterialTheme.typography.body1)
                        Text(text = "Deadline: " + task.deadline.toString(), style = MaterialTheme.typography.body1)
                    }
                }
            }
        }
