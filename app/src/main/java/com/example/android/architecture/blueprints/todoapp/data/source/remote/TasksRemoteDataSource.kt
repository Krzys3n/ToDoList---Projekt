...
object TasksRemoteDataSource : TasksDataSource {
    ...
    override suspend fun completeTask(task: Task) {
        val completedTask = Task(task.title, task.description, true, task.priority, task.deadline, task.id)
    ...
    override suspend fun activateTask(task: Task) {
        val activeTask = Task(task.title, task.description, false, task.priority, task.deadline, task.id)
